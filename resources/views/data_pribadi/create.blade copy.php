...
<div class="card card-primary m-2">
    <div class="card-header text-center">
        <h3 class="card-title text-center">Formulir Data Pribadi</h3>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-sm-12">
                            ...
                            <input type="text" class="form-control @error('alamat') is-invalid @enderror"
                                name="alamat" id="alamat" value="{{ old('alamat') }}" placeholder="Enter Alamat">
                        ...
                        <div class="form-group col-lg-3 col-md-6 col-sm-12">
                            ...
                            <select name="status_kawin" id="status_kawin"
                                ...
                                <option value="TK"{{ old('status_kawin') == 'TK' ? 'selected' : '' }}>Tidak Kawin
                                </option>
            ...
            <div class="col-lg-9 col-md-6 col-sm-12">
                <div class="form-check">
                    ...
                    <label class="form-check-label">Dengan melakukan centang anda dengan
                        kesadaran penuh bertanggung jawab atas keaslian data yang dikirim</label>
                </div>
